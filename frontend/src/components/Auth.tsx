    ...
    return (
        <div className="flex h-screen justify-center items-center">
            <div className="flex-col justify-center w-1/2">
                ...
                <div>
                    <button type="button" className=" bg-black text-white border border-gray-300 focus:outline-none hover:bg-gray-700 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 w-full mt-4">{type ===  "signup" ? "Sign up" : "Sign in"}</button>
                </div>
            </div>
        </div>
    )
